        ...
        <div class="row full-height">
            ...
            <div class="col-8 full-height main-content d-flex flex-column">
                <div class="mt-5 table-container flex-grow-1">
                    <p>Danes Deova Redina - 225150607111001</p>
                    <h2><b>Voucher Hotel</b></h2>
                    <hr>
                    <div class="container d-flex justify-content-center mt-5">
                        <div class="container1">
                            <h1>PeseninKuy</h1>
                            <div class="form-section">
                                <h2 class="h2cus">Form Check-in</h2>
                                <form id="checkinForm">
                                    ...
                                    <input type="number" id="stay_duration" name="stay_duration"
                                        placeholder="Stay Duration (days)" required>
                            ...
                            <div class="form-section">
                                ...
                                <form id="voucherForm">
                                    <input type="text" id="voucher_id" name="voucher_id" placeholder="Voucher ID"
                                        required>
                                    <button type="submit">Check Voucher</button>
                                </form>
                            </div>
