...
<head>
    ...
    <link rel="stylesheet" href="fix.css"> <!-- Tambahkan link ke file CSS -->
        ...
        <div class="row full-height">
            <div class="col-2 full-height sidebar">
                <div class="d-flex flex-column p-3 full-height">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li>
                            <a href="case3.php" class="nav-link text-white" aria-current="page">
                                <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
            ...
            <div class="col-8 full-height main-content d-flex flex-column">
                <div class="mt-5 table-container flex-grow-1">
                    <p>Citra Bunga Alfaritsa Nasution - 225150600111001</p>
                    <h2><b>Voucher Cafe</b></h2>
                    <hr>
                    <div class="container d-flex justify-content-center mt-5">
                        <div class="container1">
                            <div class="form-section">
                                <form id="transactionForm">
                                    <label for="amount">Total Pembelian:</label>
                                    <input type="number" id="amount" name="amount" required>
                                    <button type="button" onclick="checkTransaction()">Cek Transaksi</button>
                                </form>
                            </div>
